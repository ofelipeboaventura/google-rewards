...
import PageKimStart from "@/components/pages/black/kim/page";
...
export default function Page() {
  ...
  const isInfoPage = content === "kim" ? page === 5 || page === 6 : page === 4 || page === 5;
    ...
    <div className="flex flex-col w-full max-w-xl gap-5 px-4 py-5 pb-10">
      ...
      {isInfoPage && (
        <div className="flex flex-col justify-center text-center gap-3 p-4 text-gray-400/70">
          <span className="text-sm">© 2025 Google Rewards</span>
